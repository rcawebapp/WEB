  ...
  return (
    ...
    >
      <Stack spacing={3} sx={{ maxWidth: 1100, mx: 'auto', textAlign: 'center' }}>
        <Link href="/nosotros" style={{ textDecoration: 'none', color: 'inherit' }}>
          <Typography variant="h2">
            <Translate section="landing" text="¿Quienes somos?" />
          </Typography>
        </Link>
        <Box
          sx={{
        ...
        >
          <Typography sx={{ color: 'text.secondary' }}>
            <Translate
              section="landing"
              text="RCA Capital nace como una empresa destinada a gestionar el"
            />
            .
          </Typography>
        </Box>
      ...
      <Stack alignItems="center">
        <Button href="/nosotros" variant="outlined" size="large" color="inherit">
          <Translate section="landing" text="Mas sobre nosotros" />
        </Button>
      </Stack>
    </Container>
  );
