...
import { ISeminarioTeacherProp } from 'src/types/course';
import { fShortenNumber } from 'src/utils/format-number';

// ----------------------------------------------------------------------

type Props = {
  teachers: ISeminarioTeacherProp[];
};

export default function ElearningSeminarioDetailsTeachersInfo({ teachers = [] }: Props) {
  return (
    <>
