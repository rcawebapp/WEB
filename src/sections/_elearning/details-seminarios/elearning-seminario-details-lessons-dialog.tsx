...
type Props = {
  ...
  selectedLesson: ISeminarioLessonProp | null;
  onSelectedLesson: (lesson: ISeminarioLessonProp) => void;
  open: boolean;
...
export default function ElearningSeminarioDetailsLessonsDialog({
  lessons,
  selectedLesson,
  onSelectedLesson,
  open,
