...
import ElearningSeminarioItem from '../list-seminarios/elearning-seminario-item';

// ----------------------------------------------------------------------

export default function ElearningLandingFeaturedSeminarios({
  seminarios,
  locale,
}: {
      ...
      >
        <Stack spacing={3} flexGrow={1}>
          <Typography variant="h3">
            <Translate section="landing" text="Seminarios destacados" />
          </Typography>
        ...
        >
          <Carousel ref={carousel.carouselRef} {...carousel.carouselSettings}>
            {seminarios.map((seminario) => (
              ...
              >
                <ElearningSeminarioItem locale={locale} seminario={seminario} vertical />
              </Box>
            ))}
          </Carousel>
        </CarouselArrows>
